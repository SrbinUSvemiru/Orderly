...
interface DataTableFilterItemProps<TData> {
  ...
  filterItemId: string;
  joinOperator: JoinOperator;
  setJoinOperator: (_value: JoinOperator) => void;
  columns: Column<TData>[];
  onFilterUpdate: (
    _filterId: string,
    _updates: Partial<Omit<ExtendedColumnFilter<TData>, "filterId">>
  ) => void;
  onFilterRemove: (_filterId: string) => void;
}
...
function onFilterInputRender<TData>({
  ...
  setShowValueSelector: (_value: boolean) => void;
}) {
